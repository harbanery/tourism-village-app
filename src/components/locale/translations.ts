...
export const translations: Record<Locale, Record<string, string>> = {
  id: {
    ...
    "notifBell.markAllRead": "Tandai semua dibaca",
    "notifBell.justNow": "Baru saja",
    "notifBell.minutesAgo": "{n} menit lalu",
    "notifBell.hoursAgo": "{n} jam lalu",
    "notifBell.daysAgo": "{n} hari lalu",
    ...
    "checkout.detailInfo": "Detail Pesanan",
    ...
    "profile.filterAll": "Semua Status",
    "profile.sortDefault": "Urutan Default",
    "profile.sortNewest": "Terbaru",
    "profile.sortSchedule": "Reservasi Terdekat",
    "profile.noOrdersForFilter": "Tidak ada pesanan dengan status ini",
    "profile.searchOrderId": "Cari Order ID…",
    "profile.noOrdersForSearch": "Tidak ada pesanan dengan order id {q}",
    ...
    "admin.dashboard.paidTotal": "{n} order lunas (semua waktu)",
    "admin.dashboard.pendingActive": "{n} menunggu pembayaran aktif",
    "admin.dashboard.period7": "7 hari",
    "admin.dashboard.period30": "30 hari",
    "admin.dashboard.period90": "90 hari",
    "admin.dashboard.revenueTrend": "Tren pendapatan harian",
    "admin.dashboard.ordersTrend": "Order per hari (per status)",
    "admin.dashboard.statusComposition": "Komposisi status pembayaran",
    "admin.dashboard.topPackages": "Paket terlaris (lunas)",
    "admin.dashboard.homestayRatio": "Rasio menginap (item lunas)",
    "admin.dashboard.stayItem": "Menginap",
    "admin.dashboard.dayItem": "Tanpa menginap",
    "admin.dashboard.buyers": "Pengguna yang sering membeli",
    "admin.dashboard.noBuyers": "Belum ada pembelian lunas di periode ini",
    "admin.dashboard.buyerOrders": "{n} order",
    ...
    "admin.dashboard.placesWithPackages": "tempat yang sudah paket",
    ...
    "admin.tourism.notPopular": "Tidak Populer",
    ...
    "admin.orders.qrisEmpty": "QRIS belum tersedia untuk pesanan ini",
    "admin.orders.downloadInvoice": "Unduh Invoice",
    ...
    "admin.reviews.ratingBest": "Terbaik (4,5–5)",
    "admin.reviews.ratingOk": "Cukup (3–4,5)",
    "admin.reviews.ratingBad": "Buruk (< 3)",
  ...
  en: {
    ...
    "notifBell.markAllRead": "Mark all as read",
    "notifBell.justNow": "Just now",
    "notifBell.minutesAgo": "{n} min ago",
    "notifBell.hoursAgo": "{n} h ago",
    "notifBell.daysAgo": "{n} d ago",
    ...
    "checkout.detailInfo": "Order Details",
    ...
    "profile.filterAll": "All Statuses",
    "profile.sortDefault": "Default Order",
    "profile.sortNewest": "Newest",
    "profile.sortSchedule": "Earliest Reservation",
    "profile.noOrdersForFilter": "No orders with this status",
    "profile.searchOrderId": "Search Order ID…",
    "profile.noOrdersForSearch": "No orders with order id {q}",
    ...
    "admin.dashboard.successRate": "Payment success rate",
    "admin.dashboard.vsLastMonth": "vs last month",
    "admin.dashboard.paidTotal": "{n} paid orders (all time)",
    "admin.dashboard.pendingActive": "{n} active pending payments",
    "admin.dashboard.period7": "7 days",
    "admin.dashboard.period30": "30 days",
    "admin.dashboard.period90": "90 days",
    "admin.dashboard.revenueTrend": "Daily revenue trend",
    "admin.dashboard.ordersTrend": "Orders per day (by status)",
    "admin.dashboard.statusComposition": "Payment status composition",
    "admin.dashboard.topPackages": "Top packages (paid)",
    "admin.dashboard.homestayRatio": "Stay ratio (paid items)",
    "admin.dashboard.stayItem": "With stay",
    "admin.dashboard.dayItem": "Day trip",
    "admin.dashboard.buyers": "Frequent customers",
    "admin.dashboard.noBuyers": "No completed purchases in this period",
    "admin.dashboard.buyerOrders": "{n} orders",
    "admin.dashboard.revenueTotal": "Total revenue",
    "admin.dashboard.buyersTotal": "Total customers",
    "admin.dashboard.ratingSummary": "Rating",
    ...
    "admin.tourism.notPopular": "Not Popular",
    "admin.tourism.popularWarning":
    ...
    "admin.orders.qrisTitle": "QRIS",
    "admin.orders.qrisEmpty": "No QRIS available for this order",
    ...
    "admin.reviews.rating": "Rating",
    "admin.reviews.ratingBest": "Best (4.5–5)",
    "admin.reviews.ratingOk": "Okay (3–4.5)",
    "admin.reviews.ratingBad": "Bad (< 3)",
